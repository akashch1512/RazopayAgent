          ...
          >
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                borderRadius: '50%',
                background: sending ? tokens.textTertiary : accent,
                color: '#fff',
                display: 'grid',
                placeItems: 'center',
                fontSize: 12,
...
export default function CustomerDemo() {
  ...
  return (
    <div className="animate-fade-in" style={styles.shell}>
      {/* ── Top bar ── */}
      ...
      {/* ── Toast ── */}
      {notice && (
        <div className="animate-pop-in" style={styles.toast}>
      ...
      >
        ...
        <aside style={styles.leftPanel}>
          ...
          {/* Customer card */}
          {caseData ? (
            <div className="animate-fade-in-up" style={styles.customerCard}>
              <div
                style={{
                  display: 'flex',
                  gap: 10,
                  ...
                  style={{
                    ...
                    background:
                      (STATUS_STYLES[caseData.status] ||
                        STATUS_STYLES.default).bg,
                    color:
                      (STATUS_STYLES[caseData.status] ||
                        STATUS_STYLES.default).color,
                    fontSize: 9,
                    fontWeight: 700,
                    fontFamily: 'DM Mono',
                    textTransform:
          ...
          >
            ...
            {channelMessages.map((msg) => (
              <div
                key={msg.event_id}
                style={styles.messageLogRow}
              >
                <span
                  style={styles.messageLogDot}
                />
                <span style={styles.messageLogText}>
                  {msg.message}
                </span>
                <span style={styles.messageLogMeta}>
...
const STATUS_STYLES = {
  active: { bg: '#123322', color: '#4ade80' },
  processing: { bg: '#3a2a0d', color: '#fbbf24' },
  failed: { bg: '#3a1414', color: '#f87171' },
  default: { bg: '#20242b', color: tokens.textSecondary },
}
